...
#include "../InverseDynamicsIRB120/InverseDynamicsIRB120Example.h"
 ...
 ExampleEntry(1,"Constraint Feedback", "The example shows how to receive joint reaction forces in a btMultiBody. Also the applied impulse is available for a btMultiBodyJointMotor", MultiBodyConstraintFeedbackCreateFunc),
	ExampleEntry(1,"Inverted Pendulum PD","Keep an inverted pendulum up using open loop PD control", InvertedPendulumPDControlCreateFunc),
	 ...
	 ExampleEntry(0,"Inverse Dynamics"),
      ...
      ExampleEntry(1,"Inverse Dynamics URDF IRB120", "Create a btMultiBody from URDF. Create an inverse MultiBodyTree model from that. Use either decoupled PD control or computed torque control using the inverse model to track joint position targets", InverseDynamicsIRB120ExampleCreateFunc,BT_IDI_LOAD_URDF),
